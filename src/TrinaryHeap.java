...
public class TrinaryHeap {
  ...
  private static final int EXTENDSIZE = 10;
  ...
  public TrinaryHeap(ArrayList<Integer> priorities, ArrayList<Integer> items) {
    assert priorities != null : "Error: Priorities cannot be null";
    assert items !=  null : "Error: items cannot be null";
    assert priorities.size() == items.size() : "Error: The number of items and priorities should be equal in the heap.";
  ...
  public TrinaryHeap(int[] priorities, int[] items) {
    assert priorities != null : "Error: Priorities cannot be null";
    assert items !=  null : "Error: items cannot be null";
    assert priorities.length  == items.length : "Error: The number of items and prioritiees should be equal in the heap.";
   ...
   */
  private void extendNodes(int extend) {
    assert extend > 0 : "The extend parameter must be positive";

    IntNode[] newNodes = new IntNode[nodes.length + extend];
  ...
  public int indexOfHelper(int priority, int index) {
    ...
    assert priority > size : "Error: priority is greater then the size of heap ";
   ...
   */
  public void trickleUp(int index) throws IndexOutOfBoundsException {
