...
class LinkTest {
  ...
  public  static  final Direction dir = Direction.one;
  ...
  @Test
  void testToString_unsorted_withdir() {
    City city1 = new City(city1Name);
    City city2 = new City(city2Name);
    Link link = new Link(city1, city2, cityDistance, dir);
    String expectedString = city1Name + " " + cityDistance + " " + city2Name + " " + dir;
    String resultString = link.toString();
    City.cities.clear();
    assertEquals(expectedString, resultString, "toString with unsorted city names returned wrong string");
  }
